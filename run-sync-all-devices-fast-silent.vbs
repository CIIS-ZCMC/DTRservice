' ============================================================================
' ZCMC DTRService - Silent Fast Biometrics Sync Runner (Zero Window Popup)
' ============================================================================
' Purpose: Executes run-sync-all-devices-fast.bat in the background with window hidden (0).
' Works with Windows Task Scheduler or can be double-clicked without any black CMD flash.
' ============================================================================

Set objFSO = CreateObject("Scripting.FileSystemObject")
strDir = objFSO.GetParentFolderName(WScript.ScriptFullName)
strBat = strDir & "\run-sync-all-devices-fast.bat"
